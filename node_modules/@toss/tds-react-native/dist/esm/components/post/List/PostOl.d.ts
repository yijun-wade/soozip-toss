...
export declare function PostOl(props: PostOlProps): import("react/jsx-runtime").JSX.Element;
export declare namespace PostOl {
    var displayName: string;
}
export interface PostOlLiProps {
    /**
     * 컴포넌트 내부에 표시될 내용을 지정해요.
     */
    children: ReactNode;
    ...
    style?: ViewProps['style'];
    /**
     * `PostOl.Li` 컴포넌트 좌측에 순서 라벨을 지정해요.
     */
    order?: number;
}
export declare function PostOlLi({ children, style, color, order }: PostOlLiProps): import("react/jsx-runtime").JSX.Element;
export declare namespace PostOlLi {
    var displayName: string;
}
